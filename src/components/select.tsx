...
/**
 * Hub 2.0 — 40px, rounded-xs (igual `Input`), foco com focus-visible (não focus:).
 */
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ...
    className={cn(
      ...
      "whitespace-nowrap rounded-xs border border-border bg-card py-[5px] pl-[10px] pr-[26px] text-left",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "relative w-full min-w-0 cursor-default select-none rounded-xs py-0 font-sans text-sm outline-none data-[highlighted]:bg-primary/10 data-[highlighted]:text-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className,
    )}
    {...props}
  >
